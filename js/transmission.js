...
function update_torrents() {
    ...
    rpc_request(json, function(req) {
        ...
        try {
            var rv = JSON.parse(req.responseText);
            browser.browserAction.setIcon({ "path": "../img/icon-bitty.png" })
            browser.browserAction.setBadgeBackgroundColor({ "color": "#F00" });
        } catch (err) {
            browser.browserAction.setBadgeText({ "text": "?" });
            browser.browserAction.setBadgeBackgroundColor({ "color": "#7f7f7f" });
            browser.browserAction.setIcon({ "path": "../img/icon-grey-bitty.png" })
            return;
        }
